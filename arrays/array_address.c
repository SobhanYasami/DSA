...
// h1 -- Function to calculate address for 3D array (Column-major)
...
// h1 -- Generic function for n-dimensional array (Row-major)
...
// h1 -- Generic function for n-dimensional array (Column-major)
void *calculate_nd_col_major(void *base, int indices[], int dimensions[], int n, size_t element_size)
{
    int offset = 0;
    int multiplier = 1;

    // h2 -- Calculate offset using formula: i_{n-1} + i_{n-2} * d_{n-1} + i_{n-3} * d_{n-1} * d_{n-2} + ...
...
int main()
{
    ...
    // h2 -- One Dimension Array
    printf("1. ONE-DIMENSIONAL ARRAY\n");
    printf("========================\n");
    float A[10];

    // h2 -- Initialize 1D array
    for (int i = 0; i < 10; i++)
    {
        A[i] = i * 10.0f;
    }
    ...
    // h2 -- Demonstrate the calculation
    printf("\nVerification:\n");
    int i = 3;
    ...
    // h2 -- N-Dimensional Array (Generic)
    printf("\n\n4. N-DIMENSIONAL ARRAY (GENERIC)\n");
    printf("================================\n");

// h1 -- Simulate a 4D array with dimensions 2x3x4x2
#define ND 4                            // Use preprocessor directive instead of const
    ...
    // h2 -- Create a flat array that represents our n-dimensional array
    ...
    // h2 -- Initialize with predictable values
    ...
    // h2 -- Calculate the actual index in our flat array using row-major
    int actual_index = 0;
    int multiplier = 1;
    ...
    // h2 -- Additional demonstration: Access patterns
